...
public class FrameCadastrarAluno extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
						...
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								...
								.add(jPanel2Layout.createSequentialGroup()
										.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
												...
												.add(jPanel2Layout.createSequentialGroup()
														.add(jTfirstName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 161, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
														.add(30, 30, 30)
														.add(jLabel17)
														.addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
														.add(jTLastname, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 182, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
		...
		jPanel2Layout.setVerticalGroup(
				...
				.add(jPanel2Layout.createSequentialGroup()
						...
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(jLabel1)
								.add(jTfirstName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
								.add(jLabel17)
								.add(jTLastname, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
						.add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
								.add(jLabel13)
	...
	private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
		...
		Aluno a = null;
		boolean ok = false;
		//VARIAVEIS PARA CRIACAO DO OBJETO
		// ===== INFORMACOES PESSOAIS ======
		String cpf = fachada.soNumerosCPF(jFCPF.getText());//PEGA CAMPO COM CPF USSANDO A FUNCAO DA FACHADA QUE RETORNA O CPF APENAS COM NUMEROS
		String email = jTEmail.getText(); //PEGA VALOR NO CAMPO DE EMAIL
		String pNome = jTfirstName.getText();//PEGA O VALOR NO CAMPO DO PRIMEIRO NOME
		String uNome = jTLastname.getText();//PEGA O VALOR NO CAMPO DO ULTIMO NOME
		// ===== FIM INFORMACOES PESSOAIS =====
		// ===== ENDEREÇO =====
		String logradouro = jTLogradouro.getText();//PEGA CAMPO COM LOGRADOURO
		String bairro = jTextFieldBairro.getText(); // PEGA VALOR NO CAMPO COM BAIRRO
		String cidade = jTextFieldCidade.getText(); //PEGA VALOR NO CAMPO DA CIDADE
		String estado = (String) jComboBoxEstado.getSelectedItem(); //PEGA O VALOR DO ESTADO SELECIONADO
		int numero = Integer.parseInt(jTextFieldNumero.getText()); // PEGA O VALOR NO CAMPO NUMERO DO ENDEREÇO
		String[] cep1 = jFCEP.getText().toString().split("-"); // PEGA O VALOR DO CEP NO CAMPO FORMATADO NA TELA
		//FUNCAO PARA REMOVER O TRAÇO DO CEP E ADICIONA-LO NO BANCO
		String cep = "";
		for(String aux : cep1){
			cep += aux;
		}
		// ===== FIM COMPONENTES ENDEREÇO =====
		Calendar nascimento = Calendar.getInstance();//CRIA INSTANCIA DE CALENDAR PARA SALVAR DATA DE NASCIMENTO
		String posicaoAno = jCAnoNasc.getSelectedItem().toString();
		nascimento.set(Calendar.YEAR, Integer.parseInt(posicaoAno));
		...
		nascimento.set(Calendar.MONTH, posicaoMes-1);
		...
		String c = jCCursos.getSelectedItem().toString(); //PEGA O CURSO SELCIONADO NO COMBOBOX
		Curso curso = new Curso();//CRIA UM OBJETO CURSO
		curso.setNome(c);//SETA APENAS O NOME DO CURSO COM O NOME SELECIONADO NA TELA DE CADASTRO;
		try {
			Endereco aux = new Endereco(logradouro, numero, bairro, cidade, cep, estado);
